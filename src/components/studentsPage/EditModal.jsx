              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto w-full min-h-[420px]">
                  ...
                  <input
                   ...
                   {userEdited.name.length === 0 ? <label className="text-red-500 text-xs font-medium">Error: Name field cannot be left blank</label> : "" } 
                  </div>             
                  ...
                  {userEdited.class < 1 || userEdited.class > 12 ? <label className="text-red-500 text-xs font-medium">Error: Please input values between 1 & 12</label> : "" }
                  ...
                  <div className="flex-column w-full max-w-[502px]">
                    ...
                    onChange={handleChange}
                    className="w-full min-w-[502px] max-w-[502px] my-4 shadow appearance-none border rounded py-2 px-1 text-black" /> 
                  {userEdited.score < 0 || userEdited.score > 100 ? <label className="text-red-500 text-xs font-medium">Error: Please ensure score is between 0 & 100</label> : "" }
